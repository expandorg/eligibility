...
func TestWorkerProfileResponse(t *testing.T) {
	want := `{"profile":{"id":58,"worker_id":8,"birthdate":"1982-08-05T00:00:00Z","city":"Lake Verlashire","locality":"District of Columbia","country":"Netherlands","attributes":{"Gender":[{"id":1,"type":"Gender","value":"male"}]}}}`
	...
	actual, _ := json.Marshal(WorkerProfileResponse{profile})
