# Contributing to expandorg/eligibility
...
### Report bugs using Github's [issues](https://github.com/expandorg/eligibility/issues)
...
Enhancement suggestions are tracked as GitHub [issues](https://github.com/expandorg/eligibility/issues). Create an issue on this repository and provide the following information:
...
or create a directory `$GOPATH/src/github/expandorg` and execute: git clone git@github.com:expandorg/eligibility.git 
